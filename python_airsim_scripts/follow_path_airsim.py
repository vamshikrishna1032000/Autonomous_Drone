...
def airsim_follow():
    ...
    # Parameters
    global velocity
    velocity = rospy.get_param("/velocity", 0.5) # Velocity parameters set for drone movement via ROS

    # Subscribers
    rospy.Subscriber("/trajectory/spline_marker_array", MarkerArray, trajectory_callback) # This is the 'path array sent from a ROS Subscriber
